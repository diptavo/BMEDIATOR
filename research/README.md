...
`JG-0.2.8` uses cached deterministic Smolyak sparse-grid integration through
level 15 for difficult posteriors. It retains the same joint model and fixed
reporting gates. Cluster replay and new-seed development validation are
required before a frozen confirmatory run.
