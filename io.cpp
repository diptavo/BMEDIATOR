...
void write_results(const std::vector<ProteinResult>& results,
    ...
    fout << "Protein\tGene\tnA\tnB\tnC\tnC_exact\tnC_proxy\tn_rf_to_pp_obs\trf_to_pp_identifiable\t"
         ...
         << "factor_indirect_ci_upper\t"
         << "factor_fcr_alpha_BH\t"
         << "factor_beta1_fcr_ci_lower_BH\tfactor_beta1_fcr_ci_upper_BH\t"
         << "factor_beta2_fcr_ci_lower_BH\tfactor_beta2_fcr_ci_upper_BH\t"
         << "factor_indirect_fcr_ci_lower_BH\tfactor_indirect_fcr_ci_upper_BH\t"
         << "factor_fcr_alpha_BY\t"
         << "factor_beta1_fcr_ci_lower_BY\tfactor_beta1_fcr_ci_upper_BY\t"
         << "factor_beta2_fcr_ci_lower_BY\tfactor_beta2_fcr_ci_upper_BY\t"
         << "factor_indirect_fcr_ci_lower_BY\tfactor_indirect_fcr_ci_upper_BY\t"
         << "factor_conjunction_p\t"
         ...
         << "factor_fcr_bh_status\tfactor_fcr_by_status\t"
    ...
    for (auto& r : results) {
        fout << r.protein_id << "\t"
             ...
             << r.factor_fcr_alpha_bh << "\t"
             << r.factor_beta1_fcr_ci_lower_bh << "\t"
             << r.factor_beta1_fcr_ci_upper_bh << "\t"
             << r.factor_beta2_fcr_ci_lower_bh << "\t"
             << r.factor_beta2_fcr_ci_upper_bh << "\t"
             << r.factor_indirect_fcr_ci_lower_bh << "\t"
             << r.factor_indirect_fcr_ci_upper_bh << "\t"
             << r.factor_fcr_alpha_by << "\t"
             << r.factor_beta1_fcr_ci_lower_by << "\t"
             << r.factor_beta1_fcr_ci_upper_by << "\t"
             << r.factor_beta2_fcr_ci_lower_by << "\t"
             << r.factor_beta2_fcr_ci_upper_by << "\t"
             << r.factor_indirect_fcr_ci_lower_by << "\t"
             << r.factor_indirect_fcr_ci_upper_by << "\t"
             ...
             << r.factor_fcr_bh_status << "\t"
             << r.factor_fcr_by_status << "\t"
